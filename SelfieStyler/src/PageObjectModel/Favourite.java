...
public class Favourite {
	...
	@FindBy(xpath="//*[@data-product-id='529756979254']") // need to change if products change
	WebElement favourite_product1;
	
	@FindBy(xpath="//*[@data-product-id='529740267574']") // need to change if products change 
