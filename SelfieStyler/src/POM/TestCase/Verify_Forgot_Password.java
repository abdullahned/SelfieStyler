...
public class Verify_Forgot_Password {
	...
	// This will launch browser and specific url 
	   ...
	   Login_obj.enter_email("qatest0505@mailinator.com"); // enter the email to get the forgot password link
	  ...
	  Thread.sleep(4000);
	   ...
	   Forgot_Password_obj.switch_to_other_page("America0!","America0!");
